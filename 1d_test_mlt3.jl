        ...
        for l in 1:(level - 1)
            ...
            for i in 1:ns
                ...
                if l==1
                    ...
                    temp += my_C(beta, t, T)*picard_iter(v1[2], v2[2], drift_b, drift_b) * [sqrt(my_S - t), mmt*my_B / sigma] + [0, (1.0-mmt)*test1[2]]
                else
                    #test1 = mlp_v(t, T, z, gamma, sigma, l, M)
                    ...
                    #temp += my_C(beta, t, T)*picard_iter(v1[2], v2[2], min(l^(0.5), drift_b), min((l-1)^(0.5), drift_b)) * [sqrt(my_S - t), mmt*my_B / sigma] + [0, (1.0-mmt)*(test1[2]-test2[2])]
                    temp += my_C(beta, t, T)*picard_iter(v1[2], v2[2], drift_b, drift_b) * [sqrt(my_S - t), mmt*my_B / sigma] + [0, (1.0-mmt)*(test1[2]-test2[2])]
                end
            end
