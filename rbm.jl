...
function my_rtime(beta, my_rand, lb=0, ub=Inf)
...
function bm_hitting(z, gamma, my_rand, my_nu, sigma=1, elapsed=0)
...
function stopped_rbm(z, gamma, tau, time, my_rand, my_normal, sigma=1, elapsed=0)
